...
edx_d %>%
  ...
  labs(x = "Months", y = "Number of ratings", title = "Months rating comparison")+ theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
edx_d %>%
  ...
  labs(x = "Month", y = "Number of ratings", title = "Weekday and month rating comparison")+ theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
